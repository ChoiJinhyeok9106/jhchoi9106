...
//        console.log('schedule.calendarId',schedule.calendarId);
    ...
    if (options.useDetailPopup) {
        ...
        if (options.useCreationPopup) {
            onShowEditPopup = function(eventData) {
            	...
            	createView.setCalendars(getSharedFilterCalendar(baseController.calendars));
...
function getSharedFilterCalendar(calendars) {
	var filteredCalendar = new Array();

	calendars.forEach(function(cal) {
	   if(cal.boninYn) {
		   filteredCalendar.push(cal);
	   }
	});
...
module.exports = function(baseController, layoutContainer, dragHandler, options) {
    ...
    onSetCalendars = function(calendars) {
        if (createView) {
            ...
            createView.setCalendars(getSharedFilterCalendar(calendars));
        }
    };
