 ...
 * 
 * @Syntax 
 * 	$.get('/widget/template/community/faq-list.js', function(response){
 *		$('head').append(response); 
 *	});
 * 	<component :is="'faq-list'" :appid="appid" :widgetseq="widgetseq"></component>
 * 
 * @Parameters
 *  appid : 앱 아이디
 *  widgetseq : 위젯 번호
            ...
            <section class="content_box">
                <div class="inner">
                    ...
                    <li v-for="(item, index) in widgetData.data">
                      <div class="cont-box ">
									<a href="#!" @click="appOpen(index, item.BOARD_SEQ, item.BOARD_GB)">
										<div class="board-con">
											<p class="con-cate">
<!--											  <span class="label-board cate10">[{{'FAQ - ' + (index+1)}}]</span>-->
											  <span class="label-board tit">{{item.TITLE}}</span>
											</p>
<!--											<p class="con-tit">-->
